...
public class JwtTokenUtil implements Serializable {
    ...
    public String generateToken(UserDetails userDetail, Device device){
        ...
        //here we use the questional function
        //take care!
    ...
    public Boolean canTokenBeRefreshed(String token, Date lassPasswordReset){
        final Date created = getCreatedDateFromToken(token);
        return !isCreatedBeforeLastPasswordReset(created, lassPasswordReset)
